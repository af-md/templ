// Code generated by templ@0.2.418-next DO NOT EDIT.
...
func render() templ.Component {
	return templ.ComponentFunc(func(templ_7745c5c3_Ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		var templ_7745c5c3_Var2 string = templ_7745c5c3_Ctx.Value(contextKeyName).(string)
		...
		if templ_7745c5c3_Ctx.Value(contextKeyName).(string) == "test" {
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<li>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		...
		} else if templ_7745c5c3_Ctx.Value(contextKeyName).(string) == "test" {
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<li>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
